...
public class Resultado extends JFrame implements ActionListener {
	...
	public Resultado() {
		...
		txtBubble = new JTextField(message.getmsgBubble());
		txtSelection = new JTextField(message.getmsgSelection());
		txtInsertion = new JTextField(message.getmsgInsertion());
		txtQuick = new JTextField(message.getmsgQuick());
